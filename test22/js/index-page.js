$(function() {
	...
	$('.screen2 .container').css('padding-top', parseInt(HeaderTop)-80);
	$('.screen2').css('background-position-y', parseInt(HeaderTop)-80);
	...
	$('.screen4 .container').css('padding-top', parseInt(HeaderTop)-20);
	$('.screen4').css('background-position-y', parseInt(HeaderTop)-20);
	// $('.screen4 .main').css('margin-top', 20);

	$('.screen5 .container').css('padding-top', parseInt(HeaderTop)-80);
	$('.screen5').css('background-position-y', parseInt(HeaderTop)-80);
