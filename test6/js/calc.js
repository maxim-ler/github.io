...
function abc2(n) {
    ...
    $("#summ").slider({
        range: "min",
        //min: 3000, было на 3000 стало 10000(правки от 20.04.2017)
        min: 10000,
        //max: 412000, было на 300000 стало 162000(правки от 20.04.2017)
        //max: 162000, было на 162000 стало 50000(правки от 20.04.2017)
        max: 50000,
        step: 1000,
        //value: 3000, было на 3000 стало 10000(правки от 20.04.2017)
        value: 10000,
        slide: summSlide
    });
    ...
    function calculate(summ, time) {
        ...
        // Это уже в последнюю очередь делалось :(
...
$('#summInputAuto').val(abc2(copy_abc) + " р."); 
