$(function() {
	...
	$('.attention-list .item1').hover(function(e) {
	...
	$('.attention-list .item1').mouseleave(function(e) {
	...
	$('.attention-list .item2').hover(function(e) {
		$(this).find('.hidden1').hide();
		$(this).find('img').hide();
		$(this).find('div').css('padding-top', '0');
		$(this).find('.hidden2').show();
	});
	$('.attention-list .item2').mouseleave(function(e) {
		$(this).find('.hidden1').show();
		$(this).find('img').show();
	...
	$('.attention-list .item3').hover(function(e) {
		$(this).find('.hidden1').hide();
		$(this).find('img').hide();
		$(this).css('padding-top', '0');
		$(this).find('.hidden2').show();
	});
	$('.attention-list .item3').mouseleave(function(e) {
		$(this).find('.hidden1').show();
		$(this).find('img').show();
		$(this).css('padding-top', '100px');
		$(this).find('.hidden2').hide();	
	...
	$('.attention-list .item4').hover(function(e) {
		$(this).find('.hidden1').hide();
		$(this).find('img').hide();
		$(this).find('div').css('padding-top', '0');
		$(this).find('.hidden2').show();
	});
	$('.attention-list .item4').mouseleave(function(e) {
		$(this).find('.hidden1').show();
		$(this).find('img').show();
		$(this).find('div').css('padding-top', '90px');
		$(this).find('.hidden2').hide();
	...
	$('.attention-list .item5').hover(function(e) {
		$(this).find('.hidden1').hide();
		$(this).find('img').hide();
		$(this).find('span').hide();
		$(this)	.css('padding-top', '0');
	...
	$('.attention-list .item5').mouseleave(function(e) {
		$(this).find('.hidden1').show();
		$(this).find('img').show();
		$(this).find('span').show();
		$(this).css('padding-top', '100px');
	...
	$('.attention-list .item6').hover(function(e) {
		$(this).find('.hidden1').hide();
		$(this).find('img').hide();
		$(this).find('div').css('padding-top', '0');
		$(this).find('.hidden2').show();
	});
	$('.attention-list .item6').mouseleave(function(e) {
		$(this).find('.hidden1').show();
		$(this).find('img').show();
		$(this).find('div').css('padding-top', '90px');
		$(this).find('.hidden2').hide();
