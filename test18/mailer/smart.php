<?php
	...
	$mail->Username = 'plan-build18-temp@mail.ru';                 // Наш логин - временная почта!!!!!!!!
	...
	$mail->setFrom('plan-build18-temp@mail.ru', 'Заявка от клиента');   // От кого письмо 
	$mail->addAddress('plan-build18@mail.ru');     // ПОЧТА ЗАКАЗЧИКА!!!!!!!!!!!!!!!!!!!!!!!!!!
